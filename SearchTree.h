...
//		tree, arranged in ASCII order. Values that already exist in the
//		tree increment the count of that Node.
// 
// Assumptions:
// Values provided for storage are char values that have ASCII numbers
//---------------------------------------------------------------------------
...
protected:
	...
	void insertHelper(Node*& root, Collectible* item, bool& test);
	...
	bool deleteNode(Node*& root, const Collectible& item);
...
public:
	...
	//		Node is deleted.
	bool remove(const Collectible& key);
	...
	//------------------------------ depth -------------------------------------
	// Returns the depth of the Collectible stored in the SearchTree.
	// Preconditions:   None
	// Postconditions:  Returns the depth of the Collectible value passed.
	//		If no value is found, -1 is returned.
	int depth(const Collectible& item) const;

	//------------------------------ height -------------------------------------
	// Returns the height of the Collectible stored in the SearchTree.
	// Preconditions:   None
	// Postconditions:  Returns the height of the Collectible value passed.
	//		A leaf has height zero. If no value is found, -1 is returned.
	int height(const Collectible& item) const;
